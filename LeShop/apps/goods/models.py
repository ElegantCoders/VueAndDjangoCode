...
class GoodsCategory(models.Model):
    ...
    name = models.CharField(default="", max_length=32, verbose_name="类别名", help_text="类别名")  # help_text 帮助文本(提示文字)
    ...
    parent_category = models.ForeignKey('self', null=True, blank=True, verbose_name="父类目级别", help_text="父目录",
                                        related_name="sub_cat")  # related_name 外键重命名（调用可以用到这个名字）\
...
class Goods(models.Model):
    ...
    goods_desc = UEditorField(verbose_name=u"内容", imagePath="goods/images/", width=1000, height=300,
                              filePath="goods/files/", default='')  # UEditorField 百度富文本的一个包
...
class Banner(models.Model):
    ...
    首页轮播的商品
    '''
    goods = models.ForeignKey(Goods, verbose_name="商 品")
